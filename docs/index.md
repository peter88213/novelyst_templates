...
[Download the latest release (version 2.6.0)](https://github.com/peter88213/noveltree_templates/raw/main/dist/nv_templates_v2.6.0.zip)

- Extract the "nv_templates_v2.6.0" folder from the downloaded zipfile "nv_templates_v2.6.0.zip".
